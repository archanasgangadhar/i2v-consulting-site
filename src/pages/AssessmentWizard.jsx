      ...
      {showContactForm && !submitted && (
        <section className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
          ...
          <div className="w-full max-w-md bg-white rounded-xl shadow-md p-8">
            <h2 className="text-2xl font-semibold text-center text-gray-800 mb-6">Tell Us About You</h2>
            <p className="font-semibold text-center text-gray-800 mb-6">Enter your details to view results.</p>
